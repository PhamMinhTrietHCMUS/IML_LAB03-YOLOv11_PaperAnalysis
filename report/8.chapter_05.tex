...
\begin{enumerate}
    ...
    \item \textbf{YOLOv11s cân bằng:} Với 39.2 phút, YOLOv11s nằm giữa hai mô hình kia. Mặc dù sử dụng C2PSA (phức tạp hơn C2f), nhưng vẫn nhanh hơn đáng kể so với YOLOv9s.
